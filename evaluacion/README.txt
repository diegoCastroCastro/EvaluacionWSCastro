...
a persistence unit "evaluacionPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "evaluacion\pom.xml":
...
artifact ("evaluacion.war") is already built. You can build
